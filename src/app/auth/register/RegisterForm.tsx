...
export function RegisterForm() {
  ...
  return (
    <>
      {error && (
        <div className="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 text-red-700 dark:text-red-400 px-4 py-3 rounded mb-4">
          {error}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-stone-700 dark:text-zinc-300 text-sm font-medium mb-1.5">Name</label>
          <input
            type="text"
            value={name}
